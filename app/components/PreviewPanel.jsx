...
export default function PreviewPanel() {
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-[#10101d] overflow-hidden flex flex-col h-full">
      {/* Toolbar */}
      <div className="border-b border-white/10 px-4 py-3 bg-[#0b0b16]">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs rounded-md bg-violet-600 text-white hover:bg-violet-700 transition flex items-center gap-1"
            >
              🔄 Run Code
            </button>
      ...
      {/* Preview Area */}
      <div className="flex-1 bg-gradient-to-br from-gray-900 to-gray-800 overflow-auto p-6 flex items-center justify-center">
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50 z-10">
            <div className="bg-[#10101d] rounded-lg p-4 text-center">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-violet-600 mx-auto mb-2"></div>
              <p className="text-sm text-white">Loading preview...</p>
            </div>
          </div>
        )}
